    ...
    */
    ...
    function maintainPlayer(EightBitter) {
        ...
        if (player.yvel > 0) {
            ...
            //     // I think that y increases towards the bottom.
            //     // So this actually means top of player is below bottom of screen
            //     // player.top should decrease as map scrolls, but I don't think this actually happens.
            //     // player.top is in screen coordinates, but needs to be in world coordinates.
