...
public class Sprite {
  ...
  public boolean checkHorCollide(Sprite in) {
    ...
    return (leftX >= otherLeftX && leftX <= otherRightX)
        || (rightX >= otherLeftX && rightX <= otherRightX);
  }
  ...
  public boolean checkVertCollide(Sprite in) {
    ...
    return (leftY >= otherLeftY && leftY <= otherRightY)
        || (rightY >= otherLeftY && rightY <= otherRightY);
  }
